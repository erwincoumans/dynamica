...
Function .onInit	
  ...
  ReadEnvStr $R0 "MAYA_APP_DIR"
   ...
   Pop $R0   
   StrCpy $INSTDIR "$PROGRAMFILES\DynamicaBullet${DYNAMICA_VERSION}ForMaya${MAYA_VERSION}\"
FunctionEnd
...
InstallDir "$PROGRAMFILES\DynamicaBullet${MAYA_VERSION}\"
...
File "..\..\lib\release\plug-ins\DynamicaPlugin.mll"

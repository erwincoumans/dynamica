...
void* ColladaTranslator::creator()
{
    return new ColladaTranslator();
}

//////////////////////////////////////////////////////////////

MStatus ColladaTranslator::reader ( const MFileObject& file,
...
MStatus ColladaTranslator::writer ( const MFileObject& file,
                                const MString& options,
                                FileAccessMode mode )
...
bool ColladaTranslator::haveReadMethod () const
{
    return true;
}
//////////////////////////////////////////////////////////////

bool ColladaTranslator::haveWriteMethod () const
{
    return true;
}
//////////////////////////////////////////////////////////////

MString ColladaTranslator::defaultExtension () const
{
    return "dae";
}

MString ColladaTranslator::filter() const
{
	return "*.dae";
}
...
MPxFileTranslator::MFileKind ColladaTranslator::identifyFile (
...
//////////////////////////////////////////////////////////////
MStatus ColladaTranslator::exportSelected( )
{
	MStatus status;
	MString filename;
...
MStatus ColladaTranslator::exportAll( )
{
